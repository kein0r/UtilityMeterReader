...
Base 6: 1    5    2    3    1    4    4    4    0    1    2    5    3    3    0    3
        11        15        10        28        1         17        21        3
5 bits: 01011     01111     01010     11100     00001     10001     10101     00011
...
```
01011011110101011100000011000110 1010 0011 100000 00 100110111100001000100110 00 0001 00
|                                     |    |         |                           |    └── Leak now
|                                     |    |         |                           └── Leak
|                                     |    |         └── Consumption
|                                     |    └── No use (3 bits only)
...
└── Meter ID
```
- Meter ID: 0x5bd5c0c6 = 1540735174
- Meter Type: 3
- No use: 0
